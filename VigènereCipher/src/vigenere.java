/* Travis Downie(tr638019) affirm that this program is entirely my own work and that I have 
...
public class vigenere {
	...
	public static void Input(String[] args) {
		...
		try {
			...
			String pTextFile = new String();
			while(scanner2.hasNext()) {
				pTextFile += scanner2.next();
			}
			char[] charArray2 = pTextFile.toCharArray();
